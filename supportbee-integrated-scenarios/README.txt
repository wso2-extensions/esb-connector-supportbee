...
Environment Set-up:
 ...
 - Download and initialize WSO2 ESB 4.9.0 .
 ...
 - Add the sequences and templates in the "common" directory(inside <SUPPORTBEE_HOME>/supportbee-integrated-scenarios/src/common), to the ESB that are listed as below.
 ...
 02. Process Tickets
	...
	[i] Case-001
		...
		- Files:	(a) Proxy - <SUPPORTBEE_HOME>/supportbee-integrated-scenarios/src/scenarios/Process Tickets/Case 001/proxy/supportbee_createStoryAndSendNotification.xml
	...
	[ii] Case-002
		...
		- Files:	(a) Proxy - <SUPPORTBEE_HOME>/supportbee-integrated-scenarios/src/scenarios/Process Tickets/Case 002/proxy/supportbee_replyTicketAndSendSurvey.xml
					(b) Template - <SUPPORTBEE_HOME>/supportbee-integrated-scenarios/src/scenarios/Process Tickets/Case 002/templates/agilezen_getPhaseIdFromName.xml
								 - <SUPPORTBEE_HOME>/supportbee-integrated-scenarios/src/scenarios/Process Tickets/Case 002/templates/formstack_updateFieldContent.xml
	...
	[iii] Case-003
		...
		- Files:	(a) Proxy - <SUPPORTBEE_HOME>/supportbee-integrated-scenarios/src/scenarios/Process Tickets/Case 003/proxy/supportbee_sendFeedbackToAgents.xml
