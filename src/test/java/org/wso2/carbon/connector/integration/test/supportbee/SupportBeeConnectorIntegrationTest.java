...
public class SupportBeeConnectorIntegrationTest extends ConnectorIntegrationTestBase {
	...
	public void setEnvironment() throws Exception {
		...
		init("supportbee-connector-1.0.1-SNAPSHOT");
	 ...
	 */
	@Test(groups = {
			"wso2.esb" }, description = "supportbee {createTicket} integration test with mandatory parameters.")
	public void testCreateTicketWithMandatoryParameters() throws IOException, JSONException {
		...
		Assert.assertEquals(connectorProperties.getProperty("requesterEmail"),
		                    apiRestResponse.getBody().getJSONObject("ticket").getJSONObject("requester")
		                                   .getString("email"));
		Assert.assertEquals(connectorProperties.getProperty("text"),
		                    apiRestResponse.getBody().getJSONObject("ticket").getJSONObject("content").
				                    getString("text"));
		Assert.assertEquals(esbRestResponse.getBody().getJSONObject("ticket").getString("created_at"),
		                    apiRestResponse.getBody().getJSONObject("ticket").getString("created_at"));
		Assert.assertEquals(esbRestResponse.getBody().getJSONObject("ticket").getString("summary"),
		                    apiRestResponse.getBody().getJSONObject("ticket").getString("summary"));
	 ...
	 */
	@Test(groups = { "wso2.esb" }, description = "supportbee {createTicket} integration test with optional parameters.",
			dependsOnMethods = { "testCreateTicketWithMandatoryParameters" })
	public void testCreateTicketWithOptionalParameters() throws IOException, JSONException {
		...
		Assert.assertEquals(connectorProperties.getProperty("text"),
		                    apiRestResponse.getBody().getJSONObject("ticket").getJSONObject("content")
		                                   .getString("text"));
		Assert.assertEquals(connectorProperties.getProperty("copiedEmails"),
		                    apiRestResponse.getBody().getJSONObject("ticket").getJSONArray("cc").getJSONObject(0)
		                                   .getString("email"));
		Assert.assertEquals(connectorProperties.getProperty("subject"),
		                    apiRestResponse.getBody().getJSONObject("ticket").getString("subject"));
		Assert.assertEquals(connectorProperties.getProperty("requesterName"),
		                    apiRestResponse.getBody().getJSONObject("ticket").getJSONObject("requester")
		                                   .getString("name"));
		Assert.assertEquals(connectorProperties.getProperty("html"),
		                    apiRestResponse.getBody().getJSONObject("ticket").getJSONObject("content")
		                                   .getString("html"));
	}
	 ...
	 */
	@Test(groups = { "wso2.esb" }, description = "supportbee {getTicket} integration test with mandatory parameters.",
	...
	public void testGetTicketWithMandatoryParameters() throws IOException, JSONException {
		...
		Assert.assertEquals(
				esbRestResponse.getBody().getJSONObject("ticket").getJSONObject("requester").getString("email"),
				apiRestResponse.getBody().getJSONObject("ticket").getJSONObject("requester").getString("email"));
		Assert.assertEquals(
				esbRestResponse.getBody().getJSONObject("ticket").getJSONObject("content").getString("text"),
				apiRestResponse.getBody().getJSONObject("ticket").getJSONObject("content").getString("text"));
		...
		Assert.assertEquals(esbRestResponse.getBody().getJSONObject("ticket").getString("subject"),
		                    apiRestResponse.getBody().getJSONObject("ticket").getString("subject"));
		Assert.assertEquals(
				esbRestResponse.getBody().getJSONObject("ticket").getJSONObject("requester").getString("name"),
				apiRestResponse.getBody().getJSONObject("ticket").getJSONObject("requester").getString("name"));
		Assert.assertEquals(
				esbRestResponse.getBody().getJSONObject("ticket").getJSONObject("content").getString("html"),
				apiRestResponse.getBody().getJSONObject("ticket").getJSONObject("content").getString("html"));
	}
	 ...
	 */
	@Test(groups = { "wso2.esb" }, description = "supportbee {listTickets} integration test with mandatory parameters.",
			dependsOnMethods = { "testGetTicketWithMandatoryParameters" })
	public void testListTicketsWithMandatoryParameters() throws IOException, JSONException {
		...
		Assert.assertEquals(esbRestResponse.getBody().getJSONArray("tickets").length(),
		                    apiRestResponse.getBody().getJSONArray("tickets").length());
		Assert.assertEquals(
				apiRestResponse.getBody().getJSONArray("tickets").getJSONObject(0).getJSONObject("requester")
				               .getString("email"),
				apiRestResponse.getBody().getJSONArray("tickets").getJSONObject(0).getJSONObject("requester")
				               .getString("email"));
		Assert.assertEquals(esbRestResponse.getBody().getJSONArray("tickets").getJSONObject(0).getJSONObject("content")
		                                   .getString("text"),
		                    apiRestResponse.getBody().getJSONArray("tickets").getJSONObject(0).getJSONObject("content")
		                                   .getString("text"));
	 ...
	 */
	@Test(groups = { "wso2.esb" }, description = "supportbee {listTickets} integration test with optional parameters.",
			dependsOnMethods = { "testListTicketsWithMandatoryParameters" })
	 ...
	 */
	@Test(groups = { "wso2.esb" }, description = "supportbee {addLabel} integration test with mandatory parameters.",
			dependsOnMethods = { "testListTicketsWithOptionalParameters" })
	public void testAddLabelWithMandatoryParameters() throws IOException, JSONException {
		...
		Assert.assertEquals(connectorProperties.getProperty("labelName"),
		                    apiRestResponse.getBody().getJSONObject("ticket").getJSONArray("labels").getJSONObject(0)
		                                   .getString("name"));
	}
	 ...
	 */
	@Test(groups = { "wso2.esb" }, description = "supportbee {addLabel} integration test with negative case.",
			dependsOnMethods = { "testAddLabelWithMandatoryParameters" })
	public void testAddLabelWithNegativeCase() throws IOException, JSONException {
		...
		final String apiEndPoint =
				apiRequestUrl + "/tickets/" + connectorProperties.getProperty("ticketIdOptional") + "/labels/INVALID" +
				authString;
	 ...
	 */
	@Test(groups = { "wso2.esb" }, description = "supportbee {removeLabel} integration test with mandatory parameters.",
			dependsOnMethods = { "testAddLabelWithNegativeCase" })
	public void testRemoveLabelWithMandatoryParameters() throws IOException, JSONException {
		...
		Assert.assertNotEquals(apiRestResponsBefore.getBody().getJSONObject("ticket").getJSONArray("labels").length(),
		                       0);
		Assert.assertEquals(connectorProperties.getProperty("labelName"),
		                    apiRestResponsBefore.getBody().getJSONObject("ticket").getJSONArray("labels")
	...
	public void testListLabelsWithMandatoryParameters() throws IOException, JSONException {
		...
		Assert.assertEquals(esbRestResponse.getBody().getJSONArray("labels").length(),
		                    apiRestResponse.getBody().getJSONArray("labels").length());
	...
	public void testCreateReplyWithMandatoryParameters() throws IOException, JSONException {
		...
		Assert.assertEquals(connectorProperties.getProperty("textReplyMandatory"),
		                    apiRestResponse.getBody().getJSONObject("reply").getJSONObject("content")
		                                   .getString("text"));
		Assert.assertEquals(esbRestResponse.getBody().getJSONObject("reply").getString("created_at"),
		                    apiRestResponse.getBody().getJSONObject("reply").getString("created_at"));
		Assert.assertEquals(esbRestResponse.getBody().getJSONObject("reply").getString("summary"),
		                    apiRestResponse.getBody().getJSONObject("reply").getString("summary"));
	 ...
	 */
	@Test(groups = { "wso2.esb" }, description = "supportbee {createReply} integration test with optional parameters.",
			dependsOnMethods = { "testCreateReplyWithMandatoryParameters" })
	public void testCreateReplyWithOptionalParameters() throws IOException, JSONException {
		...
		Assert.assertEquals(connectorProperties.getProperty("textReplyOptional"),
		                    apiRestResponse.getBody().getJSONObject("reply").getJSONObject("content")
		                                   .getString("text"));
		Assert.assertEquals(connectorProperties.getProperty("html"),
		                    apiRestResponse.getBody().getJSONObject("reply").getJSONObject("content")
	 ...
	 */
	@Test(groups = { "wso2.esb" }, description = "supportbee {getReply} integration test with mandatory parameters.",
			dependsOnMethods = { "testCreateReplyWithOptionalParameters" })
	public void testGetReplyWithMandatoryParameters() throws IOException, JSONException {
		...
		Assert.assertEquals(esbRestResponse.getBody().getJSONObject("reply").getJSONObject("content").getString("text"),
		                    apiRestResponse.getBody().getJSONObject("reply").getJSONObject("content")
		                                   .getString("text"));
		Assert.assertEquals(esbRestResponse.getBody().getJSONObject("reply").getString("created_at"),
		                    apiRestResponse.getBody().getJSONObject("reply").getString("created_at"));
	 ...
	 */
	@Test(groups = { "wso2.esb" }, description = "supportbee {getReply} integration test with negative case.",
			dependsOnMethods = { "testGetReplyWithMandatoryParameters" })
	public void testGetReplyWithNegativeCase() throws IOException, JSONException {
		...
		final String apiEndPoint =
				apiRequestUrl + "/tickets/" + connectorProperties.getProperty("ticketIdOptional") + "/replies/987654" +
				authString;
		RestResponse<JSONObject> apiRestResponse = sendJsonRestRequest(apiEndPoint, "GET", apiRequestHeadersMap);
	 ...
	 */
	@Test(groups = { "wso2.esb" }, description = "supportbee {listReplies} integration test with mandatory parameters.",
			dependsOnMethods = { "testGetReplyWithNegativeCase" })
	public void testListRepliesWithMandatoryParameters() throws IOException, JSONException {
		...
		Assert.assertEquals(esbRestResponse.getBody().getJSONArray("replies").length(),
		                    apiRestResponse.getBody().getJSONArray("replies").length());
		Assert.assertEquals(apiRestResponse.getBody().getJSONArray("replies").getJSONObject(0).getJSONObject("replier")
		                                   .getString("email"),
		                    apiRestResponse.getBody().getJSONArray("replies").getJSONObject(0).getJSONObject("replier")
		                                   .getString("email"));
	 ...
	 */
	@Test(groups = { "wso2.esb" }, description = "supportbee {listAgents} integration test with mandatory parameters.",
	...
	public void testListAgentsWithMandatoryParameters() throws IOException, JSONException {
		...
		Assert.assertEquals(esbRestResponse.getBody().getJSONArray("users").length(),
		                    apiRestResponse.getBody().getJSONArray("users").length());
	 ...
	 */
	@Test(groups = { "wso2.esb" }, description = "supportbee {listAgents} integration test with optional parameters.",
			dependsOnMethods = { "testListAgentsWithMandatoryParameters" })
	 ...
	 */
	@Test(groups = { "wso2.esb" }, description = "supportbee {getUser} integration test with mandatory parameters.",
			dependsOnMethods = { "testListAgentsWithOptionalParameters" })
	public void testGetUserWithMandatoryParameters() throws IOException, JSONException {
		...
		Assert.assertEquals(esbRestResponse.getBody().getJSONObject("user").getString("id"),
		                    apiRestResponse.getBody().getJSONObject("user").getString("id"));
		Assert.assertEquals(esbRestResponse.getBody().getJSONObject("user").getString("email"),
		                    apiRestResponse.getBody().getJSONObject("user").getString("email"));
		Assert.assertEquals(esbRestResponse.getBody().getJSONObject("user").getString("name"),
		                    apiRestResponse.getBody().getJSONObject("user").getString("name"));
		Assert.assertEquals(esbRestResponse.getBody().getJSONObject("user").getString("agent"),
		                    apiRestResponse.getBody().getJSONObject("user").getString("agent"));
	}
	 ...
	 */
	@Test(groups = { "wso2.esb" }, description = "supportbee {assignUser} integration test with mandatory parameters.",
			dependsOnMethods = { "testGetUserWithMandatoryParameters" })
	public void testAssignUserWithMandatoryParameters() throws IOException, JSONException {
		...
		Assert.assertEquals(connectorProperties.getProperty("userId"),
		                    apiRestResponse.getBody().getJSONObject("ticket").getJSONObject("current_user_assignee")
	 ...
	 */
	@Test(groups = { "wso2.esb" }, description = "supportbee {assignUser} integration test with negative case.",
			dependsOnMethods = { "testAssignUserWithMandatoryParameters" })
	public void testAssignUserWithNegativeCase() throws IOException, JSONException {
		...
		final String apiEndPoint =
				apiRequestUrl + "/tickets/" + connectorProperties.getProperty("ticketIdOptional") + "/user_assignment" +
				authString;
		RestResponse<JSONObject> apiRestResponse =
	 ...
	 */
	@Test(groups = {
			"wso2.esb" }, description = "supportbee {createComment} integration test with mandatory parameters.",
			dependsOnMethods = { "testAssignUserWithNegativeCase" })
	public void testCreateCommentWithMandatoryParameters() throws IOException, JSONException {
		...
		for (int i = 0; i < commentsArray.length(); i++) {
			if (commentsArray.getJSONObject(i).getString("id").equals(commentIdMandatory)) {
				Assert.assertEquals(connectorProperties.getProperty("textCommentMandatory"),
				                    commentsArray.getJSONObject(i).getJSONObject("content").getString("text"));
				Assert.assertEquals(commentsArray.getJSONObject(i).getString("created_at"),
				                    commentsArray.getJSONObject(i).getString("created_at"));
	 ...
	 */
	@Test(groups = {
			"wso2.esb" }, description = "supportbee {createComment} integration test with optional parameters.",
	...
	public void testCreateCommentWithOptionalParameters() throws IOException, JSONException {
		...
		for (int i = 0; i < commentsArray.length(); i++) {
			if (commentsArray.getJSONObject(i).getString("id").equals(commentIdOptional)) {
				Assert.assertEquals(connectorProperties.getProperty("textCommentOptional"),
				                    commentsArray.getJSONObject(i).getJSONObject("content").getString("text"));
				Assert.assertEquals(connectorProperties.getProperty("html"),
				                    commentsArray.getJSONObject(i).getJSONObject("content").getString("html"));
				Assert.assertEquals(commentsArray.getJSONObject(i).getString("created_at"),
				                    commentsArray.getJSONObject(i).getString("created_at"));
				Assert.assertEquals(commentsArray.getJSONObject(i).getJSONObject("ticket").getString("comments_count"),
				                    commentsArray.getJSONObject(i).getJSONObject("ticket").getString("comments_count"));
	 ...
	 */
	@Test(groups = {
			"wso2.esb" }, description = "supportbee {listComments} integration test with mandatory parameters.",
			dependsOnMethods = { "testCreateCommentWithOptionalParameters" })
	public void testListCommentsWithMandatoryParameters() throws IOException, JSONException {
		...
		Assert.assertEquals(esbRestResponse.getBody().getJSONArray("comments").length(),
		                    apiRestResponse.getBody().getJSONArray("comments").length());
		Assert.assertEquals(apiRestResponse.getBody().getJSONArray("comments").getJSONObject(0).getJSONObject("content")
		                                   .getString("text"),
		                    apiRestResponse.getBody().getJSONArray("comments").getJSONObject(0).getJSONObject("content")
		                                   .getString("text"));
		Assert.assertEquals(apiRestResponse.getBody().getJSONArray("comments").getJSONObject(0).getJSONObject("content")
		                                   .getString("html"),
		                    apiRestResponse.getBody().getJSONArray("comments").getJSONObject(0).getJSONObject("content")
		                                   .getString("html"));
		Assert.assertEquals(esbRestResponse.getBody().getJSONArray("comments").getJSONObject(0).getString("created_at"),
		                    apiRestResponse.getBody().getJSONArray("comments").getJSONObject(0)
		                                   .getString("created_at"));
		Assert.assertEquals(
				esbRestResponse.getBody().getJSONArray("comments").getJSONObject(0).getJSONObject("commenter")
				               .getString("email"),
				apiRestResponse.getBody().getJSONArray("comments").getJSONObject(0).getJSONObject("commenter")
				               .getString("email"));
		Assert.assertEquals(
				esbRestResponse.getBody().getJSONArray("comments").getJSONObject(0).getJSONObject("commenter")
				               .getString("id"),
	 ...
	 */
	@Test(groups = {
			"wso2.esb" }, description = "supportbee {archiveTicket} integration test with mandatory parameters.",
	 ...
	 */
	@Test(groups = { "wso2.esb" }, description = "supportbee {trashTicket} integration test with mandatory parameters.",
			dependsOnMethods = { "testArchiveTicketWithMandatoryParameters" })
