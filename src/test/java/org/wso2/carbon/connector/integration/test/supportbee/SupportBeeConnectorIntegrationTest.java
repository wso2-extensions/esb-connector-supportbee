...
public class SupportBeeConnectorIntegrationTest extends ConnectorIntegrationTestBase {
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "supportbee {createComment} integration test with mandatory parameters.",
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "supportbee {createComment} integration test with optional parameters.",
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "supportbee {listComments} integration test with mandatory parameters.",
     ...
     */
    @Test(groups = {"wso2.esb"}, description = "supportbee {archiveTicket} integration test with mandatory parameters.",
